...
subge = sys.argv[1]
pop_mat = pd.read_csv(f'matrix_pop/panTE.CA-EU.{subge}.matrix', sep='\t', dtype=str, keep_default_na=False)
...
merge_df1.to_csv(f'/data2/share/home/liyi/CbpTE/ReseqTE_matrix/19Ge_reseq_matrix/int_file/panTE.CA-EU_C162-2.{subge}.map', sep='\t', index=None)